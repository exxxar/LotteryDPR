...
//
//        Users u = userService.getRepository().findUsersByEmail(ud.getUsername());
//        if (u == null) {
//            u = userService.getRepository().findUsersByLogin(ud.getUsername());
//        }
//
//        if (u == null) {
